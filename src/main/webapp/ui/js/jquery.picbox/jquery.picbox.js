...
(function($) {
	...
	*/
	...
	$.picbox = function(_images, startImage, _options) {
		...
		$(document).unbind("keyup").bind("keyup", null);
...
function quickClick2(evt){
		var evt = (evt) ? evt : window.event;
		//alert(evt.keyCode+"----"+evt.ctrlKey);
		if ($(':focus').attr("id") == "J_suggestion"){
			return false;
		}
		
		if((evt.keyCode == 49 || evt.keyCode ==97) && evt.ctrlKey){
			$(".suggestion-wrap .zui_check_list .zui_check").eq(10).trigger("click");
		}else if((evt.keyCode == 50 ||evt.keyCode ==98)  && evt.ctrlKey){
			$(".suggestion-wrap .zui_check_list .zui_check").eq(11).trigger("click");
		}else if((evt.keyCode == 51 ||evt.keyCode ==99) && evt.ctrlKey){
			$(".suggestion-wrap .zui_check_list .zui_check").eq(12).trigger("click");
		}else if((evt.keyCode == 52 ||evt.keyCode ==100) && evt.ctrlKey){
			$(".suggestion-wrap .zui_check_list .zui_check").eq(13).trigger("click");
		}else if((evt.keyCode == 53 ||evt.keyCode ==101) && evt.ctrlKey){
			$(".suggestion-wrap .zui_check_list .zui_check").eq(14).trigger("click");
		}else{
			switch(evt.keyCode){
				case 48:case 96://0
				...
				case 56:case 104: //8
					...
					break;
				case 57:case 105: //8
					$(".suggestion-wrap .zui_check_list .zui_check").eq(9).trigger("click");
					break;
				}
			}
	}
