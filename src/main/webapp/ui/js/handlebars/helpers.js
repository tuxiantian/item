...
//传入时间与当前时间比较 
Handlebars.registerHelper('compareDate', function(acceptDate,provCode,logId,options) {
	var arg = new Date(Date.parse(acceptDate.replace("-","/"))); //格式化传入的时间
	/*var now=new Date();//取今天的日期
	var flag = true;
	if(arg.getYear() < now.getYear())
		flag = false;	
	else if(arg.getMonth() < now.getMonth())
		flag = false;
	else if(arg.getDay() < now.getDay())
		flag = false;*/
	...
	var a = '';
	/*if(flag){
		a = "<a href='ManualVerifyFileServlet?logId="+logId+"&phoneType=1' title='正面' class='zpicbox'>"
		    +"	<img src='ManualVerifyFileServlet?logId="+logId+"&phoneType=1' alt='正面' width='390' >"
			+"</a>"  
			+"<a href='ManualVerifyFileServlet?logId="+logId+"&phoneType=2' title='反面' class='zpicbox'>"
			+"    <img src='ManualVerifyFileServlet?logId="+logId+"&phoneType=2' alt='反面' width='390' >"
		    +"</a>"
...
Handlebars.registerHelper('compareDate2', function(acceptDate,provCode,logId,options) {
	...
	var a = '';
	a = "<a href='ManualVerifyFileServlet?logId="+logId+"&phoneType=1&prodCode="+provCode+"&yearMM="+time+"&isPass=1' title='正面' class='zpicbox'>"
	    +"	<img src='ManualVerifyFileServlet?logId="+logId+"&phoneType=1&prodCode="+provCode+"&yearMM="+time+"&isPass=1'' alt='正面' width='250' >"
		+"</a>"  
		+"<a href='ManualVerifyFileServlet?logId="+logId+"&phoneType=2&prodCode="+provCode+"&yearMM="+time+"&isPass=1' title='反面' class='zpicbox'>"
		+"    <img src='ManualVerifyFileServlet?logId="+logId+"&phoneType=2&prodCode="+provCode+"&yearMM="+time+"&isPass=1' alt='反面' width='250' >"
	    +"</a>"
		...
		+"    <img src='ManualVerifyFileServlet?logId="+logId+"&phoneType=3&prodCode="+provCode+"&yearMM="+time+"&isPass=1' alt='手持身份证照片' width='250' >"
	    +"</a>"
	    +"<a href='ui/theme/img/wu.jpg' title='头像' class='zpicbox'>"
		+"    <img src='ui/theme/img/wu.jpg' alt='头像' width='140'>"
		+"</a>";
